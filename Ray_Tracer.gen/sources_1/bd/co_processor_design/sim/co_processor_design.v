...
(* CORE_GENERATION_INFO = "co_processor_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=co_processor_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=16,da_bram_cntlr_cnt=6,da_mb_cnt=5,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "co_processor_design.hwdef" *) 
module co_processor_design
   (BRAM_PORTB_0_addr,
    BRAM_PORTB_0_clk,
    BRAM_PORTB_0_din,
    BRAM_PORTB_0_dout,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0xC0000000 32 > co_processor_design axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  co_processor_design_axi_bram_ctrl_0_2 axi_bram_ctrl_0
  ...
  co_processor_design_axi_bram_ctrl_0_bram_1 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        ...
        .web(BRAM_PORTB_0_we));
  co_processor_design_axi_intc_0_0 axi_intc_0
       (.intr(intr_0),
  ...
  co_processor_design_axi_smc_2 axi_smc
  ...
  co_processor_design_clk_wiz_1_2 clk_wiz_1
       (.clk_in1(clk_in1_0),
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > co_processor_design microblaze_0_local_memory/dlmb_bram_if_cntlr co_processor_design axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  co_processor_design_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_XVXTNG microblaze_0_local_memory
  ...
  co_processor_design_rst_clk_wiz_1_100M_2 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_XVXTNG
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > co_processor_design microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  co_processor_design_dlmb_bram_if_cntlr_2 dlmb_bram_if_cntlr
  ...
  co_processor_design_dlmb_v10_2 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  co_processor_design_ilmb_bram_if_cntlr_2 ilmb_bram_if_cntlr
  ...
  co_processor_design_ilmb_v10_2 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  co_processor_design_lmb_bram_2 lmb_bram
